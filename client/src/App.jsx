...
function App() {
  ...
  useEffect(() => {
    fetch('https://video-upload-poc.onrender.com/folders').then(res => res.json()).then(data => {
      console.log(data)
      setFolder(data)
    })
  }, [])
  ...
  const fetchFiles = (id) => {
    fetch(`https://video-upload-poc.onrender.com/files/${id}`).then(res => res.json()).then(data => {
      console.log(data)
      setFiles(data)
    })
  }
      ...
      </>}
      {
        ...
        <div>
          ...
          <button disabled={uploading} onClick={() => {
            ...
            fetch('https://video-upload-poc.onrender.com/upload', {
              method: 'POST',
              body: formData
